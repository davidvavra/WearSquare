...
public class CheckInListAdapter extends WearableListView.Adapter {
    ...
    public CheckInListAdapter(Context context, List<Venue> items) {
        mContext = context;
        this.items = items;
    ...
    public void onBindViewHolder(WearableListView.ViewHolder viewHolder, int position) {
        ...
        listItem.text.setText(venue.name);
        listItem.image.setImageDrawable(new BitmapDrawable(mContext.getResources(), venue.icon));
